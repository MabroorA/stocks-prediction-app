    ...
    <div className="financial-summary">
      <div className="financial-summary-banner">
        <div className="banner-left">
          <img className="logo-img" src={stockSummary.image} alt={stockSummary.companyName + " Logo"} />
        </div>
        ...
        <div className="stocks-left-sections">
          ...
          <div className="stocks-left-half-blocks">
            <div className="stock-summary-section">
              <h1>Summary</h1>
              <h3>2 rows with important Information from the API response</h3> {/* Placeholder for now */}
            </div>
